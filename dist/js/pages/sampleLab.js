    ...
    function listSampleLab(){
        $.ajax({
            ...
            success: function (e){
                //console.log(e);
                var tabla = $("#TablaMuestraLaboratorio").DataTable();
                //Destruimos al DataTable anterior
                tabla.destroy();
                //Enviamos nuevas filas al cuerpo de la tabla
                $("#MuestraLaboratorio").html(e);
                //Volver a cargar el DataTable
                renderDataTable("#TablaMuestraLaboratorio");
            }
        });
    }

    //Registrar
    function registerSampleLab(){
        ...
        alert("Por favor, complete los datos");
            ...
            $.ajax({
                ...
                success: function(e){
                    //console.log(e);
                    if(confirm("¿Estas seguro de agregar esta muestra?")){
                        alert("Muestra guardado correctamente");
                        listSampleLab();
