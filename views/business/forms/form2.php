<div class="card card-success card-outline">
    <div class="card-header">
        <div class="d-flex flex-row flex-wrap justify-content-between align-items-center">
            <h4 class="text-bold text-success"><i class="far fa-keyboard mr-1"></i> FORMULARIO PROTOCOLO </h4>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 form-group">
                    ...
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="consInformado" checked>
                        <label class="form-check-label" for="consInformado">Consentimiento Informado</label>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 form-group">
                    <label for="#">&nbsp;</label>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="consDroga" checked>
                        <label class="form-check-label" for="consDroga">Consentimiento Drogas</label>
                    </div>
                </div>
            </div>
...
<div class="card card-outline card-primary">
    <div class="card-header">
        <div class="d-flex flex-row flex-wrap justify-content-between align-items-center">
            <h4 class="text-bold text-primary"><i class="fas fa-clipboard-list mr-1"></i> PROTOCOLOS </h4>
            <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
        </div> 
    </div>
    <div class="card-body">
        <div id="protocolos">
            ...
            <div class="card card-default">
                ...
                <div id="collapseOne" class="collapse show" data-parent="#protocolos">
                    <div class="card-body">
                        <table id="tableServicios" class="table table-striped table-responsive">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>SERVICIO</th>
