    ...
    <div id="wizardSkeletalMuscleDocker" class="mt-4">
      ...
      <div class="tab-content">
        <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
          <?php include 'ophthamologistsProcess/datos1.process.php'; ?>
        </div>
        <div id="step-2" class="tab-pane" role="tabpanel" aria-labelledby="step-2">
          <?php include 'ophthamologistsProcess/datos2.process.php'; ?>
        </div>
        <div id="step-3" class="tab-pane" role="tabpanel" aria-labelledby="step-3">
          <?php include 'ophthamologistsProcess/diagnostico.process.php'; ?>
        </div>
