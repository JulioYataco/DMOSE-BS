...
<div class="card card-primary">
  ...
  <div class="card-body p-0">
    ...
    <div id="wizardHistoriaAnexo7c" class="mt-4">
      ...
      <div class="tab-content">
        <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
          <?php include 'occupationalMedicalProcess/datos1.process.php'; ?>
        </div>
        <div id="step-2" class="tab-pane" role="tabpanel" aria-labelledby="step-2">
          <?php include 'occupationalMedicalProcess/datos2.process.php'; ?>
        </div>
        <div id="step-3" class="tab-pane" role="tabpanel" aria-labelledby="step-3">
          <?php include 'occupationalMedicalProcess/datos3.process.php'; ?>
        </div>
...
<script>
  $(document).ready(function() {
    $('#wizardHistoriaAnexo7c').smartWizard(smartWizardMedium);
  });
</script>