    ...
    <div id="wizardXRays" class="mt-4">
      ...
      <div class="tab-content">
        <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
          <?php include 'normalSkeletalMuscleDockersProcess/datos1.process.php'; ?>
        </div>
        <div id="step-2" class="tab-pane" role="tabpanel" aria-labelledby="step-2">
          <?php include 'normalSkeletalMuscleDockersProcess/datos2.process.php'; ?>
        </div>
...
<script>
  $(document).ready(function() {
    $('#wizardXRays').smartWizard(smartWizardMedium);
  });
</script>