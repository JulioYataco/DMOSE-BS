...
<div class="card card-primary">
  ...
  <div class="card-body p-0">
    ...
    <div id="wizardAudiometry" class="mt-4">
      ...
      <div class="tab-content">
        <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
          <?php include 'audiometryprocess/datos.process.php'; ?>
        </div>
        <div id="step-2" class="tab-pane" role="tabpanel" aria-labelledby="step-2">
          <?php include 'audiometryprocess/grafico.process.php'; ?>
        </div>
        <div id="step-3" class="tab-pane" role="tabpanel" aria-labelledby="step-3">
          <?php include 'audiometryprocess/conclusion.process.php'; ?>
        </div>
...
<script>
  $(document).ready(function() {
    $('#wizardAudiometry').smartWizard(smartWizardMedium);
  });
</script>