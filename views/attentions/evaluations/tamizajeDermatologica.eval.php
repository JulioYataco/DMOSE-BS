...
<div class="card card-primary">
  ...
  <div class="card-body p-0">
    ...
    <div id="wizardDermatological" class="mt-4">
      ...
      <div class="tab-content">
        <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
          <?php include 'dermatologicalScreeningProcess/datos.process.php'; ?>
        </div>
...
<script>
  $(document).ready(function() {
    $('#wizardDermatological').smartWizard(smartWizardMedium);
  });
</script>