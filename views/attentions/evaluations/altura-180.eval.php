    ...
    <div class="d-flex flex-row flex-wrap justify-content-between align-items-center">
      <div class="form-group-md-none">
        <h3 class='text-uppercase text-bold text-primary'>
          ...
          ESTRUCTURA MAYOR A 1.80 metros
        </h3>
      </div>
    ...
    <div id="smartwizard" class="mt-4">
      ...
      <div class="tab-content">
        <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
          <?php include 'heightprocess/antecedentes.process.php'; ?>
        </div>
        <div id="step-2" class="tab-pane" role="tabpanel" aria-labelledby="step-2">
          <?php include 'heightprocess/examenMedico.process.php'; ?>
        </div>
...
<script>
  $(document).ready(function() {
    $('#smartwizard').smartWizard(smartWizardPro);
  });
</script>