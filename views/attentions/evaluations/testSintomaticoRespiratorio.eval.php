    ...
    <div class="d-flex flex-row flex-wrap justify-content-between align-items-center">
      <div class="form-group-md-none">
        <h3 class='text-uppercase text-bold text-primary'>
          ...
          TEST DE SINTOMÁTICO RESPIRATORIO
        </h3>
      </div>
...
<div class="card card-primary">
  ...
  <div class="card-body p-0">
    ...
    <div id="wizardRespiratory" class="mt-4">
      ...
      <div class="tab-content">
        <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
          <?php include 'respiratorySymptomTestProcess/datos.process.php'; ?>
        </div>
...
<script>
  $(document).ready(function() {
    $('#wizardRespiratory').smartWizard(smartWizardMedium);
  });
</script>