    ...
    <form autocomplete="off">
      <div class="row">
        <div class="col-md-6 form-group">
          <label for="querydb">CONSULTAR BASE DE DATOS:</label>
          <div class="input-group">
            <input type="search" id="querydb" placeholder="Buscar por RUC" class="form-control">
        ...
        <div class="col-md-6 form-group">
          ...
          <div class="input-group">
            <input type="search" id="queryreniec" placeholder="Buscar por RUC" class="form-control">
            <div class="input-group-append">
              <button class="btn btn-primary" id=""><i class="fas fa-search"></i></button>
            </div>
          </div>
